  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: '#fff' }} showsVerticalScrollIndicator={false}>
      <View style={{ padding: 20, marginTop: 24 }}>
        ...
        <View style={{ marginBottom: 20 }}>
          <Image
            source={{ uri: 'https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=720/layout-engine/2023-07/Pet-Care_WEB.jpg' }} // Replace this URL with your actual banner image URL
            style={{ width: '100%', height: 290, borderRadius: 20 }}
            resizeMode="cover"
          />
        </View>
